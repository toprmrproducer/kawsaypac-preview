  ...
  function initConversionRibbons() {
    ...
    if (header && !qs(".announcement-ribbon")) {
      const announcement = buildRibbon(
        "announcement-ribbon",
        "Kawsaypac values: wildcrafted in Ecuador, transparent sourcing, herbal education, small-batch freshness, and a Shopify-ready storefront",
        [
          { label: "Transparent sourcing" },
          { label: "Herbal education" },
          { label: "Small-batch freshness" },
          { label: "Shopify-ready storefront" },
